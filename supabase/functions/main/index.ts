// Main entry point for Supabase Edge Runtime (self-hosted).
// Routes requests to individual edge functions in sibling directories.
// Based on the official Supabase self-hosted main function.
